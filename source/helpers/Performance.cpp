...
namespace LaneAndObjectDetection
{
    ...
    void Performance::EndTimer()
    {
        ...
        m_performanceInformation.m_currentFramesPerSecond = MILLISECONDS_IN_SECOND / FRAME_TIME;

        // Calculate the average FPS as a running average
        const double FRAME_COUNT = static_cast<double>(m_performanceInformation.m_frameTimes.size());
